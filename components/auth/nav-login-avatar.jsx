...
import { Avatar, Backdrop, Button, Card, CardActions, CardContent, ListItemIcon, ListItemText, Menu, MenuItem, styled, Tooltip, Typography } from "@mui/material";
...
export default function NavUserAvatar({ session }) {
  ...
  if (session?.user) {
    ...
    return (
      <>
        <NavButton variant="contained" href="/login" sx={{ display: { xs: "none", sm: "inherit" } }}>Iniciar sesión</NavButton>
        <Tooltip title="Iniciar sesión">
          <IconButton size="" startIcon={<Person />} variant="contained" href="/login" sx={{ display: { xs: "flex", sm: "none" } }} />
        </Tooltip>
      </>
    )
  }
